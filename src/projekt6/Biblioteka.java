/*
        -Programi i projektit:Biblioteka
        ...
        -Data:25/05/2021
        -Projekti 3
        -Pershkrimi:Ky program eshte i lidhur me nje database qe i lejon perdorusit te editoje.
        Programi shton rreshta ne tabele editon rreshta dhe kerkon ne tabele(database).
        */
package projekt6;
...
public final class Biblioteka extends javax.swing.JFrame {
    ...
    public Biblioteka() {
        initComponents();
        String url ="jdbc:mysql://localhost:3308/biblioteka";
    ...
    String sql="SELECT * FROM liber";
        ...
        public void Update()
        {
            try{
                ...
                conn= DriverManager.getConnection("jdbc:mysql://localhost:3308/biblioteka","root","cimcakez1");
